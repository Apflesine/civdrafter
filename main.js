...
function playersSelected() {
	...
	for (let i = 1; i <= parseInt(document.getElementById("numberOfPlayers").value); i++) {
		// dlc select dropdown
		playerListEl.innerHTML += "Player " + i + " <select class='dlcSelect' id='dlcPlayer" + i + "'><option value='none'>No DLC </option><option value='Base Game DLC'>Platinum Edition </option><option value='Frontier Pass'>Platinum Edition + Frontier Pass</option><option value='Leader Pass'>Platinum Edition + Frontier Pass + Leader Pass</option></select>"
